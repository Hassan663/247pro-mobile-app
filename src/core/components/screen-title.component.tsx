...
export const Title: React.FC<TitleTextProps> = ({ title, textAlignCenter, line, type, color, weight }) => {
    if (type == 'Poppin-10-400') return <Text style={[{ textAlign: textAlignCenter, textDecorationLine: line, color: color, fontWeight: weight }, styles.poppin_10_400]} >{title}</Text>;
    if (type == 'Poppin-11-400') return <Text style={[{ textAlign: textAlignCenter, textDecorationLine: line, color: color, fontWeight: weight }, styles.poppin_11_400]} >{title}</Text>;
    ...
    if (type == 'Poppin-24-600') return <Text style={[{ textAlign: textAlignCenter, textDecorationLine: line, color: color, fontWeight: weight }, styles.poppin_24_600]} >{title}</Text>;
