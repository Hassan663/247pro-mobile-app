...
export const styles: any = StyleSheet.create<any>({
  ...
  input: (pass: boolean, isActive: boolean) => ({
    borderWidth: pass ? 0 : RFPercentage(0.1),
    borderRadius: 5,
    borderColor: isActive ? Colors.primary : Colors.lightGrey,
    alignItems: 'center',
    paddingHorizontal: pass
      ? 0
      : platform == 'ios'
      ? RFPercentage(2)
      : RFPercentage(3),
  ...
  specialitytags: {
    backgroundColor: Colors.lightGrey,
    borderRadius: RFPercentage(0.5),
    paddingHorizontal: platform === 'ios' ? RFPercentage(1) : RFPercentage(0.8),
    ...centralStyle.mx1,
    ...centralStyle.my05,
    ...centralStyle.row,
    ...centralStyle.XAndYCenter,
  ...
  tabContainer: (selectedTab: any) => ({
    ...
    borderBottomWidth: 1,
    borderColor:
      selectedTab == t('Contacts') ? Colors.primary : Colors.lightGrey,
  ...
  tabContainer2: (selectedTab: any) => ({
    ...
    borderBottomWidth: 1,
    borderColor:
      selectedTab == t('Company') ? Colors.primary : Colors.lightGrey,
  }),
  textInput: {
