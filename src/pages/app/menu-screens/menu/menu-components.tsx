...
// CommonFeatureCard component
export const CommonFeatureCard = ({ 
    title, 
    subtitle, 
    secondarySubtitle, 
    buttonText, 
    ...
    return (
        <View style={styles.cardContainer}>
            ...
            <View style={styles.textContainer}>
                ...
                {secondarySubtitle && <Text style={styles.secondarySubtitle}>{secondarySubtitle}</Text>}
                
                {/* Read More Button */}
                <TouchableOpacity style={styles.readMoreButton} onPress={onButtonPress}>
                    <Text style={styles.readMoreText}>{buttonText}</Text>
