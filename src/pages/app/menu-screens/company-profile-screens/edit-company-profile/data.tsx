...
export const SPECIALITYDATA = [t('Architect'), t(`Flooring`), t(`Generalcontractor`), t(`Painting`), t(`Plumber`), t(`windows`),
    // t('Architect'), t(`Flooring`), t(`Generalcontractor`), t(`Painting`), t(`Plumber`), t(`windows`)
    // , t('Architect'), t(`Flooring`), t(`Generalcontractor`), t(`Painting`), t(`Plumber`), t(`windows`), t('Architect'), t(`Flooring`), t(`Generalcontractor`), t(`Painting`), t(`Plumber`), t(`windows`)
];
